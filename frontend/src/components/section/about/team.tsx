    ...
    <section className="text-center bg-white mt-[250px]">
      ...
      <div className="flex items-center justify-center gap-8 mb-[50px]">
        <div className="animate-heartbeat">
          <Image src="/assets/about/heart_left.svg" alt="Heart left" width={100} height={100} className="w-[80px] md:w-[200px] h-auto" />
        </div>
        <h2 className="text-3xl md:text-7xl font-bold bg-blue-700 text-white px-4 md:px-12 py-3 rounded-md">Our Team</h2>
        <div className="animate-heartbeat">
          <Image src="/assets/about/heart_right.svg" alt="Heart right" width={100} height={100} className="w-[80px] md:w-[200px] h-auto" />
        </div>
      </div>
