  ...
  return (
    <>
      ...
      <section className="relative bg-white pt-16 pb-5">
        ...
        <div className="absolute -top-[80px] md:-top-[120px] right-0 z-20 w-[180px] h-[180px] md:w-[500px] md:h-[500px] pointer-events-none">
          <Image
        ...
        {/* Content container */}
        <div className="relative z-10 max-w-7xl ml-12 px-0 md:px-8">
          {/* Header text */}
          <div className="mb-10 max-w-2xl">
            <h2 className="text-3xl md:text-8xl font-bold text-black leading-tight mb-4">
              Bite Size
              <br />
              Strategies
            </h2>
            <p className="text-gray-700 text-lg md:text-3xl">
        ...
        {/* YUM! Badge SVG */}
        <div className="absolute right-6 top-16 md:top-48 z-0 w-[70px] h-[70px] md:w-[150px] md:h-[150px] pointer-events-none">
          <Image
