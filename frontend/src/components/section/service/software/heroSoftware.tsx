      ...
      <section className="bg-white pt-20 md:pt-24">
        ...
        <div className="bg-black rounded-[24px] text-white px-10 md:px-16 py-16 md:py-24 flex flex-col md:flex-row items-left justify-between max-w-[1600px] mx-auto mt-5 relative overflow-hidden">
          ...
          <div className="md:w-1/2 mb-6 md:mb-0">
            ...
            By blending user psychology, data-driven <br className="hidden md:block" />
            insights, and customized strategies, we <br className="hidden md:block" />
            craft digital experiences that feel effortless, <br className="hidden md:block" />
            perform flawlessly, and adapt to your <br className="hidden md:block" />
            unique needs.
            </p>
            <br />
            <Link 
