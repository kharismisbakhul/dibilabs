      ...
      <div className="text-center">
        ...
        <div className="mt-8 space-y-3">
          ...
          {data.map((achievement, idx) => (
            ...
            <div className={`${achievement.background_color} text-white px-8 py-3 flex justify-center items-center rounded-lg`}>
              ...
              <div className="text-left ml-4">
                <p className="text-3xl md:text-[40px] leading-none">{achievement.parameter}</p>
              </div>
            </div>
          </div>
          ))}
