...
export default function CoreMeta({ data }: Props) {
  return (
    <>
      <section className="bg-white pb-16 pt-5 md:pb-24 md:pt-10 px-10">
        ...
        <div className="flex flex-row md:flex-row justify-between items-start md:items-center mb-10">
          ...
          <div className="relative mt-10 md:mt-0">
            {/* Cookie Image */}
            <div className="absolute right-0 -top-20 md:top-[-300px] md:right-0 z-40 w-[130px] md:w-[500px] h-[130px] md:h-[500px]"> {/* Added height */}
              <Image
            ...
            {/* YUM Image */}
            <div className="absolute right-[-20px] bottom-[-80px] md:bottom-[-150px] w-[60px] md:w-[150px] h-[60px] md:h-[150px]"> {/* Added height */}
              <Image
