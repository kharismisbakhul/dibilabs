    ...
    <>
      <section className="bg-white py-16 px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {
            data.map((item, idx) => (
              <div key={idx} className={`rounded-2xl ${item.background_color} relative overflow-hidden text-white text-center`}>
            <Image
            ...
            <div className="relative p-[70px]">
              <p className="text-[52px] font-bold leading-tight">{item.text1}</p>
