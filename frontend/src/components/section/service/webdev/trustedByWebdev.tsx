...
const brands = [
  "/assets/service/webdev/trustedby1.png",
  "/assets/service/webdev/trustedby2.png",
  "/assets/service/webdev/trustedby3.png",
  "/assets/service/webdev/trustedby4.png",
];

export default function TrustedByWebdev() {
  return (
