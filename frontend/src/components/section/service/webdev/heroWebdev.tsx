      ...
      <section className="bg-white pt-20 md:pt-24">
        ...
        <div className="bg-black rounded-[24px] text-white px-10 md:px-16 py-16 md:py-24 flex flex-col md:flex-row items-left justify-between max-w-[1600px] mx-auto mt-5 relative overflow-hidden">
          ...
          <div className="md:w-1/2 mb-6 md:mb-0">
            ...
            More than just an online presence, your <br className="hidden md:block" />
            website should work for you. With data-driven <br className="hidden md:block" />
            design, seamless functionality, and continuous <br className="hidden md:block" />
            optimization, we transform your platform into a <br className="hidden md:block" />
            growth engine.
            </p>
            <br />
            <Link 
          ...
          <div className="">
            <Image
              ...
              height={0}
              priority
              className="right-0 bottom-0 absolute w-[180px] md:w-[700px] h-auto"
            />
          </div>
        </div>
      </section>
