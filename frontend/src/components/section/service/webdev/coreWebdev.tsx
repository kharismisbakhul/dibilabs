...
export default function CoreWebdev({ data }: Props) {
  return (
    <>
      <section className="bg-white py-16 px-6 md:px-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
          ...
          <div className="relative mt-10 md:mt-0">
            <Image
              src="/assets/service/webdev/bite-cookies.svg" // Replace with your correct asset path
            ...
            <div className="absolute right-[-30px] bottom-[-10px]">
              <Image
                src="/assets/service/webdev/yum.svg" // Replace with your correct asset path
                alt="YUM!"
                width={100}
                height={100}
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl bg-blue-800 relative overflow-hidden text-white text-center">
            <Image
              src="/assets/service/webdev/core1.svg" // Replace with your correct asset path
              alt="Asterisk"
              width={200}
              height={200}
          ...
          <div className="rounded-2xl bg-black relative overflow-hidden text-white text-center">
            <Image
              src="/assets/service/webdev/core2.svg"
              alt="Asterisk"
              width={200}
              height={200}
              className="absolute left-0 bottom-0 opacity-30"
          ...
          <div className="rounded-2xl bg-orange-500 relative overflow-hidden text-white text-center">
            <Image
              src="/assets/service/webdev/core3.svg"
              alt="Asterisk"
              width={200}
              height={200}
              className="absolute left-0 bottom-0 opacity-30"
