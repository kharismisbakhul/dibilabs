...
export default function CoreSosmed({ data }: Props) {
  return (
    <>
      <section className="bg-white py-16 px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl bg-blue-800 relative overflow-hidden text-white text-center">
            <Image
              src="/assets/service/sosmed/core1.svg" // Replace with your correct asset path
              alt="Asterisk"
              width={200}
              height={200}
          ...
          <div className="rounded-2xl bg-black relative overflow-hidden text-white text-center">
            <Image
              src="/assets/service/sosmed/core2.svg"
              alt="Asterisk"
              width={200}
              height={200}
              className="absolute left-0 bottom-0 opacity-30"
          ...
          <div className="rounded-2xl bg-orange-500 relative overflow-hidden text-white text-center">
            <Image
              src="/assets/service/sosmed/core3.svg"
              alt="Asterisk"
              width={200}
              height={200}
              className="absolute left-0 bottom-0 opacity-30"
